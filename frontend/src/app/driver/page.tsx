    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center flex flex-col items-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700">Driver Dashboard Setup Complete</h2>
          <p className="text-gray-500 mt-2">The toggle for going Online/Offline and receiving rides will be added here in the next phase!</p>
        </div>
      </div>
    </div>
  );
